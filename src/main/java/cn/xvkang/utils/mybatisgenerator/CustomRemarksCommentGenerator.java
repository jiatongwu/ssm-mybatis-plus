 ...
 * * https://github.com/mybatis/generator/issues/23 * * @see
 * DefaultCommentGenerator#addRemarkComments
 */
public class CustomRemarksCommentGenerator extends DefaultCommentGenerator {
	@Override
